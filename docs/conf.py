# -*- coding: utf-8 -*-
#
# pytest-dbt-conventions documentation build configuration file, created by
...
project = 'pytest-dbt-conventions'
copyright = '2015, Tom Waterman'
author = 'Tom Waterman'
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', 'pytest-dbt-conventions Documentation',
     [author], 1)
]
